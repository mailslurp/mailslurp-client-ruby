...
[**get_expired_inbox_record_by_id**](InboxControllerApi.md#get_expired_inbox_record_by_id) | **GET** /inboxes/expired-records/{expiredId} | Get an expired inbox record
[**get_expired_inbox_record_by_inbox_id**](InboxControllerApi.md#get_expired_inbox_record_by_inbox_id) | **GET** /inboxes/{inboxId}/expired-record | Get expired inbox record for a previously existing inbox
[**get_expired_inbox_records**](InboxControllerApi.md#get_expired_inbox_records) | **GET** /inboxes/expired-records | List records of expired inboxes
...
## get_expired_inbox_record_by_id

> ExpiredInboxDto get_expired_inbox_record_by_id(expired_id)
...
begin
  #Get an expired inbox record
  result = api_instance.get_expired_inbox_record_by_id(expired_id)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling InboxControllerApi->get_expired_inbox_record_by_id: #{e}"
end
```
...
## get_expired_inbox_record_by_inbox_id

> ExpiredInboxDto get_expired_inbox_record_by_inbox_id(inbox_id)
...
begin
  #Get expired inbox record for a previously existing inbox
  result = api_instance.get_expired_inbox_record_by_inbox_id(inbox_id)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling InboxControllerApi->get_expired_inbox_record_by_inbox_id: #{e}"
end
```
...
## get_expired_inbox_records

> PageExpiredInboxRecordProjection get_expired_inbox_records(opts)
...
begin
  #List records of expired inboxes
  result = api_instance.get_expired_inbox_records(opts)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling InboxControllerApi->get_expired_inbox_records: #{e}"
end
```
