...
begin
  #Create an inbox ruleset
  api_instance.create_inbox_ruleset(inbox_id, create_inbox_ruleset_options)
rescue MailSlurpClient::ApiError => e
...
> list_inbox_rulesets(inbox_id, opts)
...
begin
  #List inbox rulesets
  api_instance.list_inbox_rulesets(inbox_id, opts)
rescue MailSlurpClient::ApiError => e
