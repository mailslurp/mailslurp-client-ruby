...
> Inbox create_new_email_address(use_domain_pool)
...
begin
  #Create new random inbox
  result = api_instance.create_new_email_address(use_domain_pool)
  p result
...
> Inbox create_new_email_address1(use_domain_pool)
...
begin
  #Create new random inbox
  result = api_instance.create_new_email_address1(use_domain_pool)
  p result
rescue MailSlurpClient::ApiError => e
