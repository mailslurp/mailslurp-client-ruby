...
[**get_email_html_query**](EmailControllerApi.md#get_email_html_query) | **POST** /emails/{emailId}/html-query | Parse and return text from an email, stripping HTML and decoding encoded characters
[**get_email_text_lines**](EmailControllerApi.md#get_email_text_lines) | **POST** /emails/{emailId}/text | Parse and return text from an email, stripping HTML and decoding encoded characters
...
------------- | ------------- | ------------- | -------------
 **email_id** | [**String**](.md)| ID of email to delete | 
 ...
 **email_id** | [**String**](.md)| ID of email | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **email_id** | [**String**](.md)| ID of email to match against | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **email_id** | [**String**](.md)| ID of email to perform HTML query on | 
...
> EmailTextLinesResult get_email_text_lines(decode_html_entities, email_id)
...
begin
  #Parse and return text from an email, stripping HTML and decoding encoded characters
  result = api_instance.get_email_text_lines(decode_html_entities, email_id)
  p result
rescue MailSlurpClient::ApiError => e
 ...
 **email_id** | [**String**](.md)| ID of email to fetch text for | 
