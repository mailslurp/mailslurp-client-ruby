...
[**get_organization_emails_paginated**](EmailControllerApi.md#get_organization_emails_paginated) | **GET** /emails/organization | Get all organization emails
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_ids** | [**Array&lt;String&gt;**](String.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional] 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**String**](.md)| ID of the inbox you want to get the latest email from | [optional] 
