...
[**reply_to_email1**](EmailControllerApi.md#reply_to_email1) | **PUT** /emails/{emailId} | Reply to an email
...
> SentEmailDto reply_to_email1(email_id, reply_to_email_options)
...
begin
  #Reply to an email
  result = api_instance.reply_to_email1(email_id, reply_to_email_options)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling EmailControllerApi->reply_to_email1: #{e}"
end
```
