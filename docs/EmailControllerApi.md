...
[**get_attachments**](EmailControllerApi#get_attachments) | **GET** /emails/{emailId}/attachments | Get all email attachment metadata. Metadata includes name and size of attachments.
...
> Array&lt;String&gt; download_attachment(email_id, attachment_id, opts)
...
> Array&lt;String&gt; download_body_bytes(email_id)
...
> send_email_source_optional(send_email_options, opts)
...
begin
  #Send email
  api_instance.send_email_source_optional(send_email_options, opts)
rescue MailSlurpClient::ApiError => e
