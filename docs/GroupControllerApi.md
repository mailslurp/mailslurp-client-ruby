...
update_group_contacts = MailSlurpClient::UpdateGroupContacts.new # UpdateGroupContacts | updateGroupContactsOption
 ...
 **update_group_contacts** | [**UpdateGroupContacts**](UpdateGroupContacts.md)| updateGroupContactsOption | 
