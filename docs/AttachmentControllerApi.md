...
> Array&lt;String&gt; upload_attachment_bytes(inline_object1, opts)
...
api_instance = MailSlurpClient::AttachmentControllerApi.new
inline_object1 = MailSlurpClient::InlineObject1.new # InlineObject1 | 
opts = {
...
begin
  #Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
  result = api_instance.upload_attachment_bytes(inline_object1, opts)
  p result
rescue MailSlurpClient::ApiError => e
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inline_object1** | [**InlineObject1**](InlineObject1)|  | 
