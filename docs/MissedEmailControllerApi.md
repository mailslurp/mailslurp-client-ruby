...
> MissedEmailDto get_missed_email(missed_email_id)
...
begin
  ...
  puts "Exception when calling MissedEmailControllerApi->restore_missed_emails: #{e}"
end
```
...
> MissedEmailDto wait_for_nth_missed_email(index, opts)
