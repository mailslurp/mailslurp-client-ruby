...
[**reply_to_email**](AliasControllerApi.md#reply_to_email) | **PUT** /aliases/{aliasId}/emails/{emailId} | Reply to an email
...
> SentEmailDto reply_to_email(alias_id, email_id, reply_to_alias_email_options)
...
begin
  #Reply to an email
  result = api_instance.reply_to_email(alias_id, email_id, reply_to_alias_email_options)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling AliasControllerApi->reply_to_email: #{e}"
end
```
