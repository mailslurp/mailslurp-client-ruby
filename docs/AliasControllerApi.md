...
[**get_alias_verification**](AliasControllerApi.md#get_alias_verification) | **GET** /aliases/{aliasId}/verification | Get validation result from alias verification
...
> ModelAlias create_alias(create_alias_options)
...
## get_alias_verification

> AliasVerificationResult get_alias_verification(alias_id, email_address, verification_token)
...
verification_token = 'verification_token_example' # String | verificationToken

begin
  #Get validation result from alias verification
  result = api_instance.get_alias_verification(alias_id, email_address, verification_token)
  p result
rescue MailSlurpClient::ApiError => e
  puts "Exception when calling AliasControllerApi->get_alias_verification: #{e}"
end
```
