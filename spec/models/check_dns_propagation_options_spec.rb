...
# Unit tests for MailSlurpClient::CheckDnsPropagationOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CheckDnsPropagationOptions' do
  before do
    # run before each test
    @instance = MailSlurpClient::CheckDnsPropagationOptions.new
  end
  ...
  describe 'test an instance of CheckDnsPropagationOptions' do
    it 'should create an instance of CheckDnsPropagationOptions' do
      expect(@instance).to be_instance_of(MailSlurpClient::CheckDnsPropagationOptions)
    end
  end
