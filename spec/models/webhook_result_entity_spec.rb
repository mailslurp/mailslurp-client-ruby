...
# Unit tests for MailSlurpClient::WebhookResultEntity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebhookResultEntity' do
  before do
    # run before each test
    @instance = MailSlurpClient::WebhookResultEntity.new
  end
  ...
  describe 'test an instance of WebhookResultEntity' do
    it 'should create an instance of WebhookResultEntity' do
      expect(@instance).to be_instance_of(MailSlurpClient::WebhookResultEntity)
    end
  end
  ...
  describe 'test attribute "webhook_event"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["EMAIL_RECEIVED", "NEW_EMAIL", "NEW_CONTACT", "NEW_ATTACHMENT", "EMAIL_OPENED"])
      # validator.allowable_values.each do |value|
