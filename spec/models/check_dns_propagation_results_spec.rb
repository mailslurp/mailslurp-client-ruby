...
# Unit tests for MailSlurpClient::CheckDnsPropagationResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CheckDnsPropagationResults' do
  before do
    # run before each test
    @instance = MailSlurpClient::CheckDnsPropagationResults.new
  end
  ...
  describe 'test an instance of CheckDnsPropagationResults' do
    it 'should create an instance of CheckDnsPropagationResults' do
      expect(@instance).to be_instance_of(MailSlurpClient::CheckDnsPropagationResults)
    end
  end
  ...
  describe 'test attribute "propagated_to_all_resolvers"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "responding_resolver_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "matching_resolver_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "resolver_results"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
