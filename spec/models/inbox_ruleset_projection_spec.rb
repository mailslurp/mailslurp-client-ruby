...
# Unit tests for MailSlurpClient::InboxRulesetProjection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InboxRulesetProjection' do
  before do
    # run before each test
    @instance = MailSlurpClient::InboxRulesetProjection.new
  end
  ...
  describe 'test an instance of InboxRulesetProjection' do
    it 'should create an instance of InboxRulesetProjection' do
      expect(@instance).to be_instance_of(MailSlurpClient::InboxRulesetProjection)
    end
  end
