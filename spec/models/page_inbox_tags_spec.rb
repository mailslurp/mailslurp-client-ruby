...
# Unit tests for MailSlurpClient::PageInboxTags
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PageInboxTags' do
  before do
    # run before each test
    @instance = MailSlurpClient::PageInboxTags.new
  end
  ...
  describe 'test an instance of PageInboxTags' do
    it 'should create an instance of PageInboxTags' do
      expect(@instance).to be_instance_of(MailSlurpClient::PageInboxTags)
    end
  end
