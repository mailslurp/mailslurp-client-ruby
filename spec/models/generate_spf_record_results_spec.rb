...
# Unit tests for MailSlurpClient::GenerateSpfRecordResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GenerateSpfRecordResults' do
  before do
    # run before each test
    @instance = MailSlurpClient::GenerateSpfRecordResults.new
  end
  ...
  describe 'test an instance of GenerateSpfRecordResults' do
    it 'should create an instance of GenerateSpfRecordResults' do
      expect(@instance).to be_instance_of(MailSlurpClient::GenerateSpfRecordResults)
    end
  end
  ...
  describe 'test attribute "estimated_lookup_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
