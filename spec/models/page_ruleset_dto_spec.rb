...
# Unit tests for MailSlurpClient::PageRulesetDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PageRulesetDto' do
  before do
    # run before each test
    @instance = MailSlurpClient::PageRulesetDto.new
  end
  ...
  describe 'test an instance of PageRulesetDto' do
    it 'should create an instance of PageRulesetDto' do
      expect(@instance).to be_instance_of(MailSlurpClient::PageRulesetDto)
    end
  end
