...
describe 'WebhookDto' do
  ...
  describe 'test attribute "use_static_ip_range"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "health_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["HEALTHY", "UNHEALTHY"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.health_status = value }.not_to raise_error
      # end
    end
  end
