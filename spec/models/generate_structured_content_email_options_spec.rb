...
# Unit tests for MailSlurpClient::GenerateStructuredContentEmailOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GenerateStructuredContentEmailOptions' do
  before do
    # run before each test
    @instance = MailSlurpClient::GenerateStructuredContentEmailOptions.new
  end
  ...
  describe 'test an instance of GenerateStructuredContentEmailOptions' do
    it 'should create an instance of GenerateStructuredContentEmailOptions' do
      expect(@instance).to be_instance_of(MailSlurpClient::GenerateStructuredContentEmailOptions)
    end
  end
