...
# Unit tests for MailSlurpClient::MFAControllerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MFAControllerApi' do
  before do
    # run before each test
    @api_instance = MailSlurpClient::MFAControllerApi.new
  end
  ...
  describe 'test an instance of MFAControllerApi' do
    it 'should create an instance of MFAControllerApi' do
      expect(@api_instance).to be_instance_of(MailSlurpClient::MFAControllerApi)
    end
  end

  # unit tests for create_totp_device_for_base32_secret_key
  ...
  # @param create_totp_device_base32_secret_key_options 
  # @param [Hash] opts the optional parameters
  # @return [TotpDeviceDto]
  describe 'create_totp_device_for_base32_secret_key test' do
    it 'should work' do
  ...
  # @param create_totp_device_custom_options 
  # @param [Hash] opts the optional parameters
  # @return [TotpDeviceDto]
