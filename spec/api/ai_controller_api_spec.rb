...
describe 'AIControllerApi' do
  ...
  # unit tests for get_transformer_results_table
  # Get transformer results table
  # Get AI transformer results in table format
  # @param include_meta_data 
  # @param flatten_arrays_to_rows 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :email_id 
  # @option opts [String] :sms_id 
  # @option opts [String] :attachment_id 
  ...
  describe 'get_transformer_results_table test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for test_transformer_mapping_match
  ...
  describe 'test_transformer_mapping_match test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
