...
# Unit tests for MailSlurpClient::RulesetControllerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RulesetControllerApi' do
  before do
    # run before each test
    @api_instance = MailSlurpClient::RulesetControllerApi.new
  end
  ...
  describe 'test an instance of RulesetControllerApi' do
    it 'should create an instance of RulesetControllerApi' do
      expect(@api_instance).to be_instance_of(MailSlurpClient::RulesetControllerApi)
    end
  end
