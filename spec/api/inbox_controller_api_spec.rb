...
describe 'InboxControllerApi' do
  ...
  # unit tests for does_inbox_have_automations
  # Does inbox have automations
  # Check if an inbox has automations.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'does_inbox_have_automations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_or_create_inbox_plus_address
  ...
  # @param inbox_id ID of the inbox you want to target
  # @param full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60;
  # @param [Hash] opts the optional parameters
  # @return [PlusAddressDto]
  describe 'get_or_create_inbox_plus_address test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_or_create_plus_address_by_full_address
  ...
  # @param [Hash] opts the optional parameters
  # @return [PlusAddressDto]
  describe 'get_or_create_plus_address_by_full_address test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for import_email_into_inbox
  ...
  # @param inbox_id 
  # @param import_email_options 
  # @param [Hash] opts the optional parameters
  # @return [Email]
  describe 'import_email_into_inbox test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for import_email_into_inbox_bytes
  ...
  # @return [Email]
  describe 'import_email_into_inbox_bytes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for import_email_into_inbox_multipart
  ...
  # @option opts [Boolean] :override_message_id 
  # @return [Email]
  describe 'import_email_into_inbox_multipart test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
