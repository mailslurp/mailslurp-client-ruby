...
describe 'InboxControllerApi' do
  ...
  # unit tests for get_expired_inbox_record_by_id
  ...
  describe 'get_expired_inbox_record_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_expired_inbox_record_by_inbox_id
  # Get expired inbox record for a previously existing inbox
  # Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
  # @param inbox_id ID of inbox you want to retrieve (not the inbox ID)
  # @param [Hash] opts the optional parameters
  # @return [ExpiredInboxDto]
  describe 'get_expired_inbox_record_by_inbox_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_expired_inbox_records
  ...
  describe 'get_expired_inbox_records test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
