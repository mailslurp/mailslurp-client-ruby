...
module MailSlurpClient
  ...
  class InboxPreview
    ...
    def hash
      [id, domain_id, email_address, created_at, favourite, name, tags, team_access, inbox_type, virtual_inbox, expires_at, functions_as, user_id, description, account_region].hash
    end
