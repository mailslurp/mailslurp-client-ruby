...
module MailSlurpClient
  class InvokeTransformerOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'save_results')
        self.save_results = attributes[:'save_results']
      end
    end
    ...
    def hash
      [ai_transform_id, ai_transform_mapping_id, raw_input, entity_id, entity_type, raw_conditions, raw_instructions, raw_output_schema, content_selector, save_results].hash
    end
