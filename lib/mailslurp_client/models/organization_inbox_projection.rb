...
module MailSlurpClient
  ...
  class OrganizationInboxProjection
    ...
    def hash
      [id, domain_id, created_at, name, email_address, favourite, tags, team_access, inbox_type, read_only, virtual_inbox, functions_as, user_id, description, expires_at, account_region].hash
    end
