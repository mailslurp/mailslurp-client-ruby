...
module MailSlurpClient
  class CreateConnectorOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'fetch_settings')
        self.fetch_settings = attributes[:'fetch_settings']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fetch_settings == o.fetch_settings
    end
    ...
    def hash
      [connector_type, connector_auth_type, imap_settings, inbox_id, sync_enabled, sync_schedule_type, sync_interval, fetch_settings].hash
    end
