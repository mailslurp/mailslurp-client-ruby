...
module MailSlurpClient
  class GenerateSpfRecordResults
    ...
    attr_accessor :estimated_lookup_count
    ...
    def self.attribute_map
      {
        ...
        :'ttl' => :'ttl',
        :'value' => :'value',
        :'estimated_lookup_count' => :'estimatedLookupCount',
        :'warnings' => :'warnings'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'ttl' => :'Integer',
        :'value' => :'String',
        :'estimated_lookup_count' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MailSlurpClient::GenerateSpfRecordResults` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MailSlurpClient::GenerateSpfRecordResults`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'estimated_lookup_count')
        self.estimated_lookup_count = attributes[:'estimated_lookup_count']
      end
    ...
    def list_invalid_properties
      ...
      if @estimated_lookup_count.nil?
        invalid_properties.push('invalid value for "estimated_lookup_count", estimated_lookup_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @estimated_lookup_count.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ttl == o.ttl &&
          value == o.value &&
          estimated_lookup_count == o.estimated_lookup_count &&
          warnings == o.warnings
    end
    ...
    def hash
      [name, type, ttl, value, estimated_lookup_count, warnings].hash
    end
