...
module MailSlurpClient
  class FakeEmailDto
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'attachment_names')
        if (value = attributes[:'attachment_names']).is_a?(Array)
          self.attachment_names = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @attachment_names.nil?
        invalid_properties.push('invalid value for "attachment_names", attachment_names cannot be nil.')
      end
      ...
      if @body_url.nil?
        invalid_properties.push('invalid value for "body_url", body_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @attachment_names.nil?
      return false if @body.nil?
      return false if @seen.nil?
      return false if @created_at.nil?
      return false if @content_type.nil?
      return false if @body_url.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          attachment_names == o.attachment_names &&
          subject == o.subject &&
          preview == o.preview &&
          body == o.body &&
          seen == o.seen &&
    ...
    def hash
      [id, email_address, sender, recipients, attachment_names, subject, preview, body, seen, created_at, content_type, body_url].hash
    end
