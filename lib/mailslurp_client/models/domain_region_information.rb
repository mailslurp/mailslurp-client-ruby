...
module MailSlurpClient
  class DomainRegionInformation
    ...
    attr_accessor :creation_enabled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MailSlurpClient::DomainRegionInformation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MailSlurpClient::DomainRegionInformation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'creation_enabled')
        self.creation_enabled = attributes[:'creation_enabled']
      end
    ...
    def list_invalid_properties
      ...
      if @creation_enabled.nil?
        invalid_properties.push('invalid value for "creation_enabled", creation_enabled cannot be nil.')
      end

      if @sending_enabled.nil?
        invalid_properties.push('invalid value for "sending_enabled", sending_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @creation_enabled.nil?
      return false if @sending_enabled.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          creation_enabled == o.creation_enabled &&
    ...
    def hash
      [domain_name, verified, domain_type, account_region, creation_enabled, sending_enabled, active].hash
    end
