...
module MailSlurpClient
  ...
  class DeliverabilitySelectorOptions
    ...
    attr_accessor :exclude_entity_ids
    ...
    def self.openapi_types
      {
        ...
        :'exclude_entity_ids' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MailSlurpClient::DeliverabilitySelectorOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MailSlurpClient::DeliverabilitySelectorOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'exclude_entity_ids')
        if (value = attributes[:'exclude_entity_ids']).is_a?(Array)
          self.exclude_entity_ids = value
        end
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["ALL", "PATTERN", "EXPLICIT"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["ALL", "PATTERN", "EXPLICIT"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exclude_entity_ids == o.exclude_entity_ids
    end
    ...
    def hash
      [type, pattern, phone_country, entity_ids, exclude_entity_ids].hash
    end
