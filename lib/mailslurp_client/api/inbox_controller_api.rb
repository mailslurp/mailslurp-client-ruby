...
module MailSlurpClient
  class InboxControllerApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [RulesetDto]
    def create_inbox_ruleset(inbox_id, create_ruleset_options, opts = {})
      data, _status_code, _headers = create_inbox_ruleset_with_http_info(inbox_id, create_ruleset_options, opts)
      data
    end
    ...
    def create_inbox_ruleset_with_http_info(inbox_id, create_ruleset_options, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_ruleset_options.nil?
        fail ArgumentError, "Missing the required parameter 'create_ruleset_options' when calling InboxControllerApi.create_inbox_ruleset"
      end
      # resource path
    ...
    # @option opts [String] :search Optionally filter by search words partial matching name and email address
    ...
    def get_all_inboxes_with_http_info(opts = {})
      ...
      query_params[:'before'] = opts[:'before'] if !opts[:'before'].nil?
      query_params[:'inboxType'] = opts[:'inbox_type'] if !opts[:'inbox_type'].nil?
      query_params[:'inboxFunction'] = opts[:'inbox_function'] if !opts[:'inbox_function'].nil?
      query_params[:'domainId'] = opts[:'domain_id'] if !opts[:'domain_id'].nil?
    ...
    # @option opts [String] :domain_id Optional domain ID filter
    # @return [PageInboxProjection]
    def get_all_inboxes_offset_paginated(opts = {})
      data, _status_code, _headers = get_all_inboxes_offset_paginated_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :domain_id Optional domain ID filter
    # @return [Array<(PageInboxProjection, Integer, Hash)>] PageInboxProjection data, response status code and response headers
    def get_all_inboxes_offset_paginated_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InboxControllerApi.get_all_inboxes_offset_paginated ...'
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && opts[:'sort'] && !allowable_values.include?(opts[:'sort'])
        fail ArgumentError, "invalid value for \"sort\", must be one of #{allowable_values}"
      ...
      # resource path
      local_var_path = '/inboxes/offset-paginated'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InboxControllerApi#get_all_inboxes_offset_paginated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PlusAddressDto]
    def get_or_create_inbox_plus_address(inbox_id, full_address, opts = {})
      data, _status_code, _headers = get_or_create_inbox_plus_address_with_http_info(inbox_id, full_address, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PlusAddressDto, Integer, Hash)>] PlusAddressDto data, response status code and response headers
    def get_or_create_inbox_plus_address_with_http_info(inbox_id, full_address, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InboxControllerApi.get_or_create_inbox_plus_address ...'
      end
      # verify the required parameter 'inbox_id' is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_or_create_inbox_plus_address"
      end
      # verify the required parameter 'full_address' is set
      if @api_client.config.client_side_validation && full_address.nil?
        fail ArgumentError, "Missing the required parameter 'full_address' when calling InboxControllerApi.get_or_create_inbox_plus_address"
      end
      if @api_client.config.client_side_validation && full_address.to_s.length < 1
        fail ArgumentError, 'invalid value for "full_address" when calling InboxControllerApi.get_or_create_inbox_plus_address, the character length must be great than or equal to 1.'
      end

      # resource path
      local_var_path = '/inboxes/{inboxId}/plus-addresses/get-or-create'.sub('{' + 'inboxId' + '}', CGI.escape(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InboxControllerApi#get_or_create_inbox_plus_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PlusAddressDto]
    def get_or_create_plus_address_by_full_address(full_address, opts = {})
      data, _status_code, _headers = get_or_create_plus_address_by_full_address_with_http_info(full_address, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PlusAddressDto, Integer, Hash)>] PlusAddressDto data, response status code and response headers
    def get_or_create_plus_address_by_full_address_with_http_info(full_address, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InboxControllerApi.get_or_create_plus_address_by_full_address ...'
      end
      # verify the required parameter 'full_address' is set
      if @api_client.config.client_side_validation && full_address.nil?
        fail ArgumentError, "Missing the required parameter 'full_address' when calling InboxControllerApi.get_or_create_plus_address_by_full_address"
      end
      if @api_client.config.client_side_validation && full_address.to_s.length < 1
        fail ArgumentError, 'invalid value for "full_address" when calling InboxControllerApi.get_or_create_plus_address_by_full_address, the character length must be great than or equal to 1.'
      end

      # resource path
      local_var_path = '/inboxes/get-or-create-plus-address'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InboxControllerApi#get_or_create_plus_address_by_full_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
