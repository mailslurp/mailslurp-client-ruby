...
module MailSlurpClient
  class DomainControllerApi
    ...
    def get_available_domain_regions(opts = {})
      data, _status_code, _headers = get_available_domain_regions_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :inbox_type 
    # @return [Array<(DomainRegionGroupsDto, Integer, Hash)>] DomainRegionGroupsDto data, response status code and response headers
    def get_available_domain_regions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainControllerApi.get_available_domain_regions ...'
      end
      ...
      # resource path
      local_var_path = '/domains/available-domain-regions'
      ...
      # return_type
      return_type = opts[:return_type] || 'DomainRegionGroupsDto' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainControllerApi#get_available_domain_regions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
