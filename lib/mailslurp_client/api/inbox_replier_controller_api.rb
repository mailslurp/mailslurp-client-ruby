...
module MailSlurpClient
  class InboxReplierControllerApi
    ...
    def get_all_inbox_replier_events(opts = {})
      data, _status_code, _headers = get_all_inbox_replier_events_with_http_info(opts)
      data
    end
    ...
    def get_all_inbox_replier_events_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InboxReplierControllerApi.get_all_inbox_replier_events ...'
      end
      ...
      # resource path
      local_var_path = '/repliers/events'

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'inboxReplierId'] = opts[:'inbox_replier_id'] if !opts[:'inbox_replier_id'].nil?
      query_params[:'inboxId'] = opts[:'inbox_id'] if !opts[:'inbox_id'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InboxReplierControllerApi#get_all_inbox_replier_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
