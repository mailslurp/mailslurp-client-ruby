...
module MailSlurpClient
  class SmsControllerApi
    ...
    # @param sms_id [String] ID of SMS to extract codes from
    # @param [Hash] opts the optional parameters
    # @option opts [ExtractCodesOptions] :extract_codes_options 
    # @return [ExtractCodesResult]
    def get_sms_codes(sms_id, opts = {})
      data, _status_code, _headers = get_sms_codes_with_http_info(sms_id, opts)
      data
    end
    ...
    def get_sms_codes_with_http_info(sms_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SmsControllerApi.get_sms_codes ...'
      end
      # verify the required parameter 'sms_id' is set
      if @api_client.config.client_side_validation && sms_id.nil?
        fail ArgumentError, "Missing the required parameter 'sms_id' when calling SmsControllerApi.get_sms_codes"
      end
      # resource path
      local_var_path = '/sms/{smsId}/codes'.sub('{' + 'smsId' + '}', CGI.escape(sms_id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SmsControllerApi#get_sms_codes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :read  (default to true)
    # @option opts [String] :phone_number_id 
    # @return [nil]
    def mark_all_sms_as_read(opts = {})
      mark_all_sms_as_read_with_http_info(opts)
      nil
    end
    ...
    # Sets read state for all SMS messages, optionally scoped to a single phone number. Use &#x60;read&#x3D;false&#x60; to reset unread state in bulk.
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :read 
    # @option opts [String] :phone_number_id 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def mark_all_sms_as_read_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SmsControllerApi.mark_all_sms_as_read ...'
      end
      # resource path
      local_var_path = '/sms/read'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SmsControllerApi#mark_all_sms_as_read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Boolean] :read  (default to true)
    # @return [SmsDto]
    def mark_sms_as_read(sms_id, opts = {})
      data, _status_code, _headers = mark_sms_as_read_with_http_info(sms_id, opts)
      data
    end
    ...
    # @option opts [Boolean] :read 
    # @return [Array<(SmsDto, Integer, Hash)>] SmsDto data, response status code and response headers
    def mark_sms_as_read_with_http_info(sms_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SmsControllerApi.mark_sms_as_read ...'
      end
      # verify the required parameter 'sms_id' is set
      if @api_client.config.client_side_validation && sms_id.nil?
        fail ArgumentError, "Missing the required parameter 'sms_id' when calling SmsControllerApi.mark_sms_as_read"
      end
      # resource path
      local_var_path = '/sms/{smsId}/read'.sub('{' + 'smsId' + '}', CGI.escape(sms_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SmsControllerApi#mark_sms_as_read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
