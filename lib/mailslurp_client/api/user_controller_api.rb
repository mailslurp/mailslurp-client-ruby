...
module MailSlurpClient
  class UserControllerApi
    ...
    def create_or_update_inbox_retention_policy_for_account(create_inbox_retention_policy_for_account_options, opts = {})
      data, _status_code, _headers = create_or_update_inbox_retention_policy_for_account_with_http_info(create_inbox_retention_policy_for_account_options, opts)
      data
    end
    ...
    def create_or_update_inbox_retention_policy_for_account_with_http_info(create_inbox_retention_policy_for_account_options, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserControllerApi.create_or_update_inbox_retention_policy_for_account ...'
      end
      ...
      if @api_client.config.client_side_validation && create_inbox_retention_policy_for_account_options.nil?
        fail ArgumentError, "Missing the required parameter 'create_inbox_retention_policy_for_account_options' when calling UserControllerApi.create_or_update_inbox_retention_policy_for_account"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_inbox_retention_policy_for_account_options) 

      # return_type
      return_type = opts[:return_type] || 'InboxRetentionPolicyDto' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserControllerApi#create_or_update_inbox_retention_policy_for_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_inbox_retention_policy_for_account(opts = {})
      data, _status_code, _headers = delete_inbox_retention_policy_for_account_with_http_info(opts)
      data
    end
    ...
    def delete_inbox_retention_policy_for_account_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserControllerApi.delete_inbox_retention_policy_for_account ...'
      end
      # resource path
      local_var_path = '/user/inbox-retention-policies/account'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserControllerApi#delete_inbox_retention_policy_for_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_inbox_retention_policy_for_account(opts = {})
      data, _status_code, _headers = get_inbox_retention_policy_for_account_with_http_info(opts)
      data
    end
    ...
    def get_inbox_retention_policy_for_account_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserControllerApi.get_inbox_retention_policy_for_account ...'
      end
      # resource path
      local_var_path = '/user/inbox-retention-policies/account'
      ...
      # return_type
      return_type = opts[:return_type] || 'InboxRetentionPolicyOptionalDto' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserControllerApi#get_inbox_retention_policy_for_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
