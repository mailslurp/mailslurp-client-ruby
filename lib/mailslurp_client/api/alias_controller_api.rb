...
module MailSlurpClient
  class AliasControllerApi
    ...
    # @option opts [DateTime] :since Optional filter by sent after given date time
    # @option opts [DateTime] :before Optional filter by sent before given date time
    # @return [Array<(PageAliasThreadProjection, Integer, Hash)>] PageAliasThreadProjection data, response status code and response headers
    def get_alias_threads_with_http_info(alias_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PageAliasThreadProjection' 
    ...
    # @param thread_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AliasThreadProjection, Integer, Hash)>] AliasThreadProjection data, response status code and response headers
    def get_thread_with_http_info(thread_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'AliasThreadProjection' 
