...
module MailSlurpClient
  class WebhookControllerApi
    ...
    # @option opts [String] :event_type_source Webhook source type category such as phone, inbox, aiTranformer
    # @option opts [Boolean] :include_account_wide Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters
    # @return [PageWebhookProjection]
    ...
    def get_all_webhooks_with_http_info(opts = {})
      ...
      allowable_values = ["INBOX", "PHONE", "AI_TRANSFORMER"]
      if @api_client.config.client_side_validation && opts[:'event_type_source'] && !allowable_values.include?(opts[:'event_type_source'])
        fail ArgumentError, "invalid value for \"event_type_source\", must be one of #{allowable_values}"
      end
      # resource path
      ...
      query_params[:'eventTypeSource'] = opts[:'event_type_source'] if !opts[:'event_type_source'].nil?
      query_params[:'includeAccountWide'] = opts[:'include_account_wide'] if !opts[:'include_account_wide'].nil?
    ...
    # @option opts [String] :health Filter by webhook health
    # @option opts [String] :event_type Optional event type
    # @option opts [Boolean] :include_account_wide Include account scope inbox webhooks
    # @return [PageWebhookProjection]
    ...
    # @option opts [String] :search_filter Optional search filter
    # @option opts [String] :health Filter by webhook health
    # @option opts [Boolean] :include_account_wide Include account scope phone webhooks
    # @return [PageWebhookProjection]
    ...
    # @param webhook_id [String] ID of webhook to get results for
    # @param expected_count [Integer] Expected result count
