...
```shell
gem install ./mailslurp_client-5.2.0.gem
```
(for development, run `gem install --dev ./mailslurp_client-5.2.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'mailslurp_client', '~> 5.2.0'
...
*MailSlurpClient::ExtraOperationsApi* | [**create_domain**](docs/ExtraOperationsApi.md#create_domain) | **POST** /domains | Create Domain
...
*MailSlurpClient::ExtraOperationsApi* | [**delete_domain**](docs/ExtraOperationsApi.md#delete_domain) | **DELETE** /domains/{id} | Delete a domain
...
*MailSlurpClient::ExtraOperationsApi* | [**get_domain**](docs/ExtraOperationsApi.md#get_domain) | **GET** /domains/{id} | Get a domain
*MailSlurpClient::ExtraOperationsApi* | [**get_domains**](docs/ExtraOperationsApi.md#get_domains) | **GET** /domains | Get domains
...
*MailSlurpClient::ExtraOperationsApi* | [**get_emails_paginated**](docs/ExtraOperationsApi.md#get_emails_paginated) | **GET** /emails | Get all emails
...
## Documentation for Models
 ...
 - [MailSlurpClient::DomainPlusVerificationRecordsAndStatus](docs/DomainPlusVerificationRecordsAndStatus.md)
